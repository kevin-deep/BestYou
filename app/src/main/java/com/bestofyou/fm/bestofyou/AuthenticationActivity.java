...
public class AuthenticationActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,View.OnClickListener{
    SignInButton mSignInButton;
    Button mSignOutButton, mRevokeButton;
    TextView mStatus;
    ...
    /***
     *  handle the result getting back from pending intent(google service)
     * @param requestCode
     * @param resultCode
     * @param data
     */
